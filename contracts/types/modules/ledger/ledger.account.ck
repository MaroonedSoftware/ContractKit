...
contract LedgerAccount: { # Represents a ledger account
    ...
    currency: string(length=3) | CustomCurrency = "USD" # The ledger account currency code or custom currency
    exponent: readonly int # The ledger account currency exponent
    description?: string(max=1024) # The ledger account description
    createdAt: readonly datetime # The ledger account creation date
    updatedAt: readonly datetime # The ledger account last update date
