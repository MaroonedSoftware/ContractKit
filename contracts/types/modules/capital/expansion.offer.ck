...
contract ExpansionCapitalOffer: { # Represents an expansion offer
    ...
    currency: string(length=3) | CustomCurrency = "USD" # The currency of the expansion offer
    exponent: readonly int # The exponent of the expansion offer
    expiresAt: datetime # The expiration date of the expansion offer
    status: readonly OfferStatus # The status of the expansion offer
...
contract ExpansionCapitalOfferTerm: { # Represents an expansion offer term   
    ...
    accepted: readonly boolean # Whether the expansion offer term has been accepted
    capitalAmount: bigint(min=0) # The capital amount of the expansion offer term
    originationFee: bigint(min=0) # The origination fee of the expansion offer term
    holdback: { # The holdback of the expansion offer term
        percentage: int(min=0, max=100) # The percentage of the holdback
        amount: bigint(min=0) # The amount of the holdback
    } 
}