...
- 9726e29: Give an operation's response-headers `TypedDict` its own name when the operation also declares request headers.
...
- 772aa77: The generated Python SDK passes `mypy --strict`.
...
- cca6eae: Send query and header params in the forms a ContractKit router parses, including a `query:` or `headers:` declared as a model.
