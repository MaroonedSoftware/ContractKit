...
async function runKotlinCodegen(
    ...
    const globalFiles: IncrementalOutputFile[] = [
        ...
        { relativePath: `${srcRoot}/${sdkName}.kt`, content: generateAggregatorPlaceholder(packageName, sdkName) },
    ];
...
/**
 * The aggregator before clients exist. Replaced by the real one once the client generator lands;
 * emitted now so the output tree is a compilable Kotlin source set at every step.
 */
function generateAggregatorPlaceholder(packageName: string, sdkName: string): string {
    return `// Auto-generated by @contractkit/plugin-kotlin. Do not edit manually.
package ${packageName}
