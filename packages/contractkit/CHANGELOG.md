...
- a440886: `bigint` and `decimal` bounds keep the digits the source wrote.
...
- 17f4261: Add `deriveSdkMethodName(op, route)`, the TypeScript SDK's method-naming rule: `sdk:` verbatim, then
