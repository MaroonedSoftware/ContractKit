...
export const FIXTURES = ['billing.ck', 'hyphenated.ck', 'kitchen.ck', 'simple.ck'] as const;
...
function makePlugins(): { name: PluginName; plugin: ContractKitPlugin }[] {
    return [
        ...
        {
            name: 'kotlin',
            plugin: createKotlinSdkPlugin({ baseDir: 'ktsdk', packageName: 'com.example.sdk', sdkName: 'KitchenSink', scaffold: true }, ROOT_DIR),
        },
        {
            name: 'swift',
