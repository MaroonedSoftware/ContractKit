...
function serializeScalar(type: { name: string; min?: number | bigint; max?: number | bigint; len?: number; regex?: string; format?: string }): string {
  const args: string[] = [];
